	...
	<view>
		...
		<navigator url="/pages/address/address?source=1" class="address-section">
			<view class="order-content">
				...
				<view class="cen">
					<view class="top">
						<text class="name">{{addressData.contactName}}</text>
						<text class="mobile">{{addressData.contactPhone}}</text>
					</view>
				</view>
		...
		<view class="goods-section">
			<view class="g-header b-b">
				<text class="name">预定信息</text>
			</view>
			<!-- 商品列表 -->
			<view class="g-item">
				<image :src="urlKey+serviceData.logo"></image>
				<view class="right">
					<text class="title clamp">{{serviceData.name}}({{serviceData.typeInfo}})</text>
		...
		<view class="yt-list">
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">服务</text>
				<text class="cell-tip">用心服务</text>
			</view>
		</view>
	...
	export default {
		...
		methods: {
			...
			submit(){
				...
				let contactName = this.addressData.contactName;
				let contactPhone = this.addressData.contactPhone;
				uni.request({
					...
					success: (res) => {
						if(res.data.code == '0'){
							uni.redirectTo({
								url: '/pages/order/serviceorder?state=0'
							})
						}
					}
				});
			...
			stopPrevent(){},
			loadData(){
				this.totalPrice = this.serviceData.price;
